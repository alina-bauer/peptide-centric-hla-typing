...
nextflow run nf-core/mhcquant -r 2.5.0 \
	-profile cfc \
	--input '/sfs/9/ws/qeasc01-allotypic_peptides/samplesheets/samplesheet_MSV000084172_pre2017.tsv' \
	--outdir '/sfs/9/ws/qeasc01-allotypic_peptides/results/MSV000084172/pre2017' \
    ...
    --variable_mods 'Oxidation (M)' 'pyro-Glu (N-term Q)' \
    -resume