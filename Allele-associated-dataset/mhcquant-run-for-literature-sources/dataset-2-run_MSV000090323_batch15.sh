...
nextflow run nf-core/mhcquant -r 2.5.0 \
	-profile cfc \
	--input '/sfs/9/ws/qeasc01-allotypic_peptides/samplesheets/samplesheet_MSV000090323_batch15.tsv' \
	--outdir '/sfs/9/ws/qeasc01-allotypic_peptides/results/MSV000090323/batch15' \
